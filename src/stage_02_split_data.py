import pandas as pd
import argparse
from src.utils.common_utils import read_params, clean_previous_dirs_if_exist, create_dir, save_local_df
import logging
...
def split_and_save_data(config_path):
    ...
    processed_data_dir = artifacts["split_data"]["processed_data_dir"]
